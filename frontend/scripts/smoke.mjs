...
assertIncludes(searchSettingsActions, "toSearxngOptionsPayload(await requestSettingsJson(`/api/settings/web-search/searxng-options${suffix}`))", "search settings actions converts unknown SearXNG options responses through typed payload boundary");
