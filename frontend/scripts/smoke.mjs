...
assertIncludes(providerAuthActions, "scheduleProviderAuthPoll(providerId, settingsState[config.authKey]", "provider auth actions schedule polling through provider config");
