...
assertIncludes(providerSettingsActions, "...CODEX_AUTH_STATE_KEYS", "provider settings actions reuse Codex auth state keys");
assertIncludes(providerSettingsActions, "...COPILOT_AUTH_STATE_KEYS", "provider settings actions reuse Copilot auth state keys");
...
assertIncludes(chatClient, "...CODEX_AUTH_STATE_KEYS", "chat client reuses Codex auth state keys");
assertIncludes(chatClient, "...COPILOT_AUTH_STATE_KEYS", "chat client reuses Copilot auth state keys");
