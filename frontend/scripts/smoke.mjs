...
assertIncludes(chatClient, "startProviderAuthLogin(providerAuthFlowConfigs[\"openai-codex\"])", "chat client keeps Codex auth login wrapper");
assertIncludes(chatClient, "startProviderAuthLogin(providerAuthFlowConfigs.copilot)", "chat client keeps Copilot auth login wrapper");
assertIncludes(chatClient, "logoutProviderAuth(providerAuthFlowConfigs[\"openai-codex\"])", "chat client keeps Codex auth logout wrapper");
assertIncludes(chatClient, "logoutProviderAuth(providerAuthFlowConfigs.copilot)", "chat client keeps Copilot auth logout wrapper");
assertIncludes(chatClient, "pollProviderAuthLogin(providerAuthFlowConfigs[\"openai-codex\"])", "chat client keeps Codex auth poll wrapper");
assertIncludes(chatClient, "pollProviderAuthLogin(providerAuthFlowConfigs.copilot)", "chat client keeps Copilot auth poll wrapper");
