...
assertIncludes(providerAuthMetadata, "PROVIDER_AUTH_PROVIDER_IDS = Object.keys(PROVIDER_AUTH_SECTIONS)", "provider auth metadata derive auth provider ids from section metadata");
