...
assertIncludes(providerAuthConfigs, "providerAuthRequestConfig(codexAuthConfig)", "provider auth configs build Codex request metadata from provider section lookup");
assertIncludes(providerAuthConfigs, "providerAuthRequestConfig(copilotAuthConfig)", "provider auth configs build Copilot request metadata from provider section lookup");
