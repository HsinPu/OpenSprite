...
assertIncludes(providerAuthActions, "const oauthProviderConfigs", "provider auth actions centralize OAuth provider configs");
...
assertIncludes(providerAuthActions, "authNoticeKey: CODEX_AUTH_STATE_KEYS.noticeKey", "provider auth actions keep Codex OAuth notice state key");
assertIncludes(providerAuthActions, "authNoticeKey: COPILOT_AUTH_STATE_KEYS.noticeKey", "provider auth actions keep Copilot OAuth notice state key");
...
assertIncludes(providerAuthActions, "provider?.id === COPILOT_PROVIDER_ID ? COPILOT_PROVIDER_ID : CODEX_PROVIDER_ID", "provider auth actions keep default OAuth provider selection");
...
assertIncludes(providerAuthActions, "startProviderAuthLogin(providerAuthConfig(CODEX_PROVIDER_ID))", "provider auth actions keep Codex auth login wrapper");
assertIncludes(providerAuthActions, "startProviderAuthLogin(providerAuthConfig(COPILOT_PROVIDER_ID))", "provider auth actions keep Copilot auth login wrapper");
assertIncludes(providerAuthActions, "logoutProviderAuth(providerAuthConfig(CODEX_PROVIDER_ID))", "provider auth actions keep Codex auth logout wrapper");
assertIncludes(providerAuthActions, "logoutProviderAuth(providerAuthConfig(COPILOT_PROVIDER_ID))", "provider auth actions keep Copilot auth logout wrapper");
assertIncludes(providerAuthActions, "pollProviderAuthLogin(providerAuthConfig(CODEX_PROVIDER_ID))", "provider auth actions keep Codex auth poll wrapper");
assertIncludes(providerAuthActions, "pollProviderAuthLogin(providerAuthConfig(COPILOT_PROVIDER_ID))", "provider auth actions keep Copilot auth poll wrapper");
