...
function FutureSettingRow({ label, description }: { label: string; description: string }) { return <div className="settings-future-row" aria-label={`${label}，未來上線`}><span><span className="settings-control-label">{label}</span><span className="settings-control-description">{description}</span></span><span className="settings-future-badge">未來上線</span></div>; }
