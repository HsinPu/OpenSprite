...
assertIncludes(sidebarNav, "brand-mark-expand", "collapsed sidebar floating expand affordance");
assertIncludes(sidebarNav, "v-if=\"collapsed\"", "floating expand affordance only appears collapsed");
...
assertIncludes(styles, ".app-shell--sidebar-collapsed .brand-mark-wrap:hover .brand-mark-expand", "collapsed sidebar brand hover expand styling");
