"""Run file-change recording and guarded revert operations."""
...
from ...core.contracts.persistence import StoredRunFileChange
...
from ...core.text_changes import format_unified_diff, text_sha256
