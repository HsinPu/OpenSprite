...
from ...core.ports.media import ImageAnalysisProvider, SpeechToTextProvider, VideoAnalysisProvider
...
def media_router_status(router: MediaRouter) -> dict[str, bool]:
    """Return provider availability without depending on application composition."""
    return {
