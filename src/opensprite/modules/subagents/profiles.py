"""Pure subagent tool-profile policy and validation helpers."""
...
from ...core.contracts.tool_names import WEB_SOURCE_TOOL_NAMES
...
def profile_for_subagent(
    ...
    *,
    ...
    """Return the runtime profile for a subagent id and optional metadata override."""
    metadata_profile = normalize_metadata_value(tool_profile)
    if metadata_profile:
