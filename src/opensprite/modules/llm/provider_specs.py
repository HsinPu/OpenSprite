...
from .llm_presets import provider_default_base_url as profile_default_base_url
from .provider_ids import COPILOT_PROVIDER_ID, MINIMAX_PROVIDER_ID, OPENAI_PROVIDER_ID, OPENROUTER_PROVIDER_ID
...
PROVIDERS = (
    ...
    ProviderSpec(
        ...
        default_base_url=profile_default_base_url(COPILOT_PROVIDER_ID),
