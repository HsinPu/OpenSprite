...
from .value_utils import truncate as _truncate
...
def task_contract_follow_up_instruction(task_contract: TaskContract | None) -> str:
    ...
    if is_web_research_task_type(task_type) or task_contract_requires_web_source_evidence(task_contract):
        return (
