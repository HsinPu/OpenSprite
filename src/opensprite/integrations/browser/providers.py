...
class BrowserbaseCloudProvider(_CloudBrowserProvider):
    backend = "browserbase"
...
class BrowserUseCloudProvider(_CloudBrowserProvider):
    backend = "browser-use"
...
class FirecrawlCloudProvider(_CloudBrowserProvider):
    backend = "firecrawl"
