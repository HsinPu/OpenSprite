...
from .provider_base import CloudBrowserProvider as _CloudBrowserProvider
from .providers import (
    BrowserUseCloudProvider as _BrowserUseCloudProvider,
    BrowserbaseCloudProvider as _BrowserbaseCloudProvider,
    FirecrawlCloudProvider as _FirecrawlCloudProvider,
)
...
BROWSER_CLOUD_PROVIDER_TYPES = {
    _BrowserbaseCloudProvider.backend: _BrowserbaseCloudProvider,
    _BrowserUseCloudProvider.backend: _BrowserUseCloudProvider,
    _FirecrawlCloudProvider.backend: _FirecrawlCloudProvider,
}
