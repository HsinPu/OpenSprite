...
from .provider_base import (
    ...
    CloudBrowserProvider as _CloudBrowserProvider,
    CloudBrowserSession as _CloudBrowserSession,
)
...
class AgentBrowserRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        cloud_provider: _CloudBrowserProvider | None = None,
    ):
        ...
        self._cloud_sessions: dict[str, _CloudBrowserSession] = {}
    ...
    async def _run_subprocess(self, argv: list[str], timeout: int) -> dict[str, Any]:
        try:
            ...
            raise _BrowserRuntimeError(str(exc)) from exc
