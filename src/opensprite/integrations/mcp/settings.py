"""MCP server settings validation and persistence adapter."""
...
from ...config.defaults import DEFAULT_MCP_SERVERS_FILE
from ...config.json_files import load_json_dict, write_json_dict
from ...config.schema import Config, MCPServerConfig
