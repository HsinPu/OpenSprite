...
from ....core.contracts.web_search import (
    ...
    WEB_SEARCH_FRESHNESS_OPTIONS as _WEB_SEARCH_FRESHNESS_OPTIONS,
    WEB_SEARCH_PROVIDERS as _WEB_SEARCH_PROVIDERS,
)
from ...search.searxng_http import searxng_endpoint_url as _searxng_endpoint_url
...
def coerce_web_search_provider(
    value: Any,
    *,
    default_provider: str = _DEFAULT_WEB_SEARCH_PROVIDER,
    providers: tuple[str, ...] | list[str] = _WEB_SEARCH_PROVIDERS,
) -> str:
...
def coerce_web_search_freshness(
    ...
    *,
    ...
    freshness_values: tuple[str, ...] | list[str] = _WEB_SEARCH_FRESHNESS_OPTIONS,
) -> str:
...
def searxng_config_url(searxng_url: str) -> str:
    return _searxng_endpoint_url(searxng_url, "/config")
