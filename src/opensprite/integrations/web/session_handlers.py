"""Session and storage HTTP handlers for the Web integration."""
...
from ...core.contracts.messages import CLI_VIA_WEB_TURN_SOURCE, TURN_SOURCE_METADATA_KEY
from ...core.contracts.channel_identity import channel_from_session, external_chat_id_from_session
from ...modules.runs.presentation import serialize_diff_summary
from ...modules.runs.session_entries import serialize_session_entries
...
async def handle_sessions(adapter: Any, request: web.Request) -> web.Response:
    ...
    hidden_by_session_id = {}
    channel_totals: dict[str, int] = {"all": 0}
    ...
    return web.json_response(
        {
            "sessions": sessions,
            "channel": channel_filter or adapter.channel_instance_id,
            "total": len(filtered_session_ids),
            "limit": session_limit,
