"""HTTP API handlers for the Web integration adapter."""
...
from ...core.contracts.channel_identity import channel_from_session, external_chat_id_from_session
from ...modules.session_commands.catalog import session_command_catalog
...
class WebApiHandlers:
    ...
    async def handle_run_events(self, request: web.Request) -> web.Response:
        return await run_handlers.handle_run_events(self.adapter, request)

    async def handle_runs(self, request: web.Request) -> web.Response:
        return await run_handlers.handle_runs(self.adapter, request)
    ...
    async def handle_sessions(self, request: web.Request) -> web.Response:
        return await session_handlers.handle_sessions(self.adapter, request)

    async def handle_sessions_delete(self, request: web.Request) -> web.Response:
        return await session_handlers.handle_sessions_delete(
            self.adapter,
            request,
    ...
    async def handle_session_status(self, request: web.Request) -> web.Response:
        return await session_handlers.handle_session_status(self.adapter, request)

    async def handle_run_trace(self, request: web.Request) -> web.Response:
        return await run_handlers.handle_run_trace(self.adapter, request)

    async def handle_run_summary(self, request: web.Request) -> web.Response:
        return await run_handlers.handle_run_summary(self.adapter, request)

    async def handle_run_cancel(self, request: web.Request) -> web.Response:
        return await run_handlers.handle_run_cancel(self.adapter, request)

    async def handle_run_file_change_revert(self, request: web.Request) -> web.Response:
        return await run_handlers.handle_run_file_change_revert(self.adapter, request)
