"""
opensprite/app/messaging/dispatcher.py - 訊息排程中心
...
from ...core.contracts.bus_events import InboundMessage, OutboundMessage, RunEvent, SessionStatusEvent
...
from ...modules.documents.scope import CURATOR_SCOPE_CHOICES as _CURATOR_SCOPE_CHOICES
from ...modules.session_commands.catalog import (
    CommandDef,
    first_command_token,
...
from ...modules.scheduling.manager import CronSessionResetInProgress
from .message_bus import MessageBus
from .session_status import SessionStatusService, SessionStatusType
from ...modules.scheduling.presentation import render_cron_jobs
from ...modules.scheduling.types import CronSchedule
...
from ...core.contracts.run_lifecycle import ACTIVE_RUN_EVENTS, RUN_STARTED_EVENT, TERMINAL_RUN_EVENTS
    ...
    async def _handle_curator_command(
        ...
        *,
        ...
        if action == "run":
            ...
            if scope and scope not in _CURATOR_SCOPE_CHOICES:
                return self.messages.curator.invalid_scope.format(
                    scope=scope,
                    scopes=", ".join(_CURATOR_SCOPE_CHOICES),
                )
