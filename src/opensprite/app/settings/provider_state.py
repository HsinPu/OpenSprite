...
from ...integrations.auth.credentials import DEFAULT_LLM_CAPABILITY, add_credential, set_provider_default
from ...integrations.auth.provider_credentials import has_provider_secret
from ...integrations.llm.provider_discovery import (
    cached_openrouter_model_metadata,
    positive_int_or_none,
)
from ...modules.llm.llm_presets import ProviderPreset, load_llm_presets
from ...modules.llm.provider_auth_types import API_KEY_AUTH_TYPE
...
from ...modules.llm.reasoning import (
