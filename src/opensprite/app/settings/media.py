...
from ...config.json_files import load_json_dict
from .provider_state import (
    connected_provider_entries,
    load_provider_config_state,
)
from ...config.schema import Config, OcrConfig, SpeechConfig, VideoConfig, VisionConfig
from ...integrations.auth.provider_credentials import resolve_provider_api_key
from ...integrations.llm.provider_discovery import discover_media_model_choices
from ...modules.llm.llm_presets import load_llm_presets
from ...modules.llm.provider_choices import (
...
def _provider_media_config(
    ...
    *,
    ...
    return {
        ...
        "base_url": _provider_media_base_url(provider_id, provider),
    }
    ...
    def _section_provider_id(self, config: Any, providers: dict[str, Any]) -> str:
        ...
        for candidate_id, provider in providers.items():
            if not isinstance(provider, dict):
                continue
            media_config = _provider_media_config(
                candidate_id,
                provider,
