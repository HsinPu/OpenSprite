"""Bind application-owned tools to an AgentLoop instance."""

from __future__ import annotations

from typing import Any

from ..agent import media_runtime
...
def register_default_agent_tools(agent: Any) -> None:
    ...
    register_default_tools(
        ...
        history_search_store=agent.history_search_store,
        history_search_config=agent.history_search_config,
        ...
        queue_outbound_media=lambda kind, payload: media_runtime.queue_outbound_media(
            agent,
            kind,
            payload,
        ),
