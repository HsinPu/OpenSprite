"""Application-owned composition of the built-in tool registry."""
...
from ...modules.media.outbound import outbound_media_error_result
from ...modules.media.router import MediaRouter
from ...modules.scheduling.manager import CronManager
from .media.audio import TranscribeAudioTool
from ...modules.tools.batch import BatchTool
...
from ...integrations.browser.factory import (
    cloud_provider_from_config as _cloud_provider_from_config,
)
from ...integrations.browser.runtime import AgentBrowserRuntime as _AgentBrowserRuntime
from .workspace.code_navigation import CodeNavigationTool
from .auth.credential_store import CredentialStoreTool
from .scheduling.cron import CronTool
from .workspace.filesystem import (
    ApplyPatchTool,
    EditFileTool,
    GlobFilesTool,
    GrepFilesTool,
...
from .media.image import AnalyzeImageTool, OCRImageTool
from .documents.memory import SaveMemoryTool
from .mcp.configure import ConfigureMCPTool
from .media.outbound_media import SendMediaTool
from .processes.management import ProcessTool
from ...integrations.processes.background_runtime import BackgroundProcessManager
from ...modules.tools.registry import ToolRegistry
from .runs.file_changes import ListRunFileChangesTool, PreviewRunFileChangeRevertTool
from .search.history import SearchHistoryTool
from .processes.exec import ExecTool
from .skills.read import ReadSkillTool
from .skills.configure import ConfigureSkillTool
from .verification.verify import VerifyTool
from .media.video import AnalyzeVideoTool
from .subagents.workflow import RunWorkflowTool
from .web.fetch import WebFetchTool
...
def register_config_tools(
    ...
    *,
    ...
    from .subagents.configure import ConfigureSubagentTool
...
def register_browser_tools(
    ...
    *,
    ...
    runtime = _AgentBrowserRuntime(
        ...
        cloud_provider=_cloud_provider_from_config(browser_config) if browser_config is not None else None,
    )
...
def register_delegate_tools(
    ...
    *,
    ...
    from .subagents.delegate import DelegateTool
    ...
    if run_subagents_many is not None:
        from .subagents.delegate_many import DelegateManyTool
