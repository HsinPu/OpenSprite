...
from opensprite.integrations.search.duckduckgo import (
    search_duckduckgo as _search_duckduckgo_provider,
)
from opensprite.integrations.search.searxng import (
    clean_text_values as _clean_text_values,
    search_searxng as _search_searxng_provider,
)
from opensprite.modules.search.presentation import format_error as _format_error
from opensprite.modules.search.provider_routing import (
...
from opensprite.modules.tools.web_search_parameters import (
    web_search_parameters as _web_search_parameters,
)
from opensprite.modules.search.web_policy import web_search_request as _web_search_request
...
class WebSearchTool(Tool):
    ...
    async def _search_duckduckgo(self, query: str, n: int, freshness: str) -> str:
        ...
        return await _search_duckduckgo_provider(query, n, freshness)

    async def _search_searxng(self, query: str, n: int, freshness: str) -> str:
        return await _search_searxng_provider(
            query,
            n,
            freshness,
