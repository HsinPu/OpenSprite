"""Media provider composition for application startup and hot reload."""

from __future__ import annotations

from ..config import Config
from ..integrations.media.audio import OpenAICompatibleSpeechProvider
from ..integrations.media.image import create_image_analysis_provider
from ..integrations.media.video import OpenAICompatibleVideoProvider
