"""One-shot CLI adapter for local chat turns."""
...
from ...core.contracts.channel_identity import build_session_id, normalize_identifier
...
from ...core.contracts.run_lifecycle import TERMINAL_RUN_EVENTS
