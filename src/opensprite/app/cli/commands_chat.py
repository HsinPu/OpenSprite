...
from ...integrations.workspace.paths import get_session_workspace, get_tool_workspace
from ...integrations.network.environment import apply_network_environment
from ...core.contracts.run_events import TOOL_STARTED_EVENT
...
from ..lifecycle import stop_background_task
from opensprite.integrations.observability.logging import setup_log
from .chat_adapter import CliAdapter as _CliAdapter, CliChatResult as _CliChatResult
...
async def run_cli_chat(
    ...
    *,
    ...
    workspace_snapshot: str | Path | None = None,
    timeout_seconds: float = 300.0,
) -> tuple[_CliChatResult, dict[str, Any]]:
...
def result_payload(result: _CliChatResult, trace_summary: dict[str, Any]) -> dict[str, Any]:
...
def _render_text(result: _CliChatResult, trace_summary: dict[str, Any]) -> None:
