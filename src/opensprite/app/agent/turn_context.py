...
from ...modules.media.outbound import queue_outbound_media, queued_outbound_media
...
class TurnContextService:
    ...
    def queue_outbound_media(self, kind: str, payload: str) -> str | None:
        ...
        return queue_outbound_media(self._current_outbound_media.get(), kind, payload)

    def queued_outbound_media(self) -> dict[str, list[str]]:
        """Return queued outbound media for the current turn."""
        return queued_outbound_media(self._current_outbound_media.get())
