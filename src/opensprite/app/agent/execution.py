...
from ...modules.runs.provider_retry import retry_delay_from_error
...
from ...core.contracts.tool_names import is_verification_tool_name
from ...core.contracts.tool_results import classify_tool_result_status, tool_error_result
from ...core.contracts.verification import classify_verification_result
from .execution_support.assistant_visible_text import (
    sanitize_assistant_visible_text,
    strip_assistant_internal_scaffolding,
)
from .execution_support.log_redaction import redact_log_preview
from opensprite.core.logging import logger
from ...core.run_tracking.state import RunCancelledError
from ...core.contracts.execution_events import (
...
from .execution_support.tool_loop_guardrail import (
    ToolLoopGuardrail,
...
class ExecutionResult:
    ...
    delegated_tasks: tuple[delegation_contracts.StoredDelegatedTask, ...] = ()
...
"""
    ...
    async def _execute_messages_with_provider(
        ...
        *,
        ...
        delegated_tasks: list[delegation_contracts.StoredDelegatedTask] = []
        active_delegate_task_id: str | None = None
        active_delegate_prompt_type: str | None = None
