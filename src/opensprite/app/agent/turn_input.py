...
from ...core.contracts.messages import (
    CLI_VIA_WEB_TURN_SOURCE as _CLI_VIA_WEB_TURN_SOURCE,
    CLIENT_TURN_ID_METADATA_KEY,
    TURN_SOURCE_METADATA_KEY as _TURN_SOURCE_METADATA_KEY,
    UserMessage,
)
...
def metadata_is_cli_via_web(metadata: dict[str, Any]) -> bool:
    return metadata_value_matches(
        metadata,
        _TURN_SOURCE_METADATA_KEY,
        _CLI_VIA_WEB_TURN_SOURCE,
    )
...
class TurnInputPreparer:
    ...
    def __init__(
        self,
        *,
        media_service: InboundMediaPersistence,
