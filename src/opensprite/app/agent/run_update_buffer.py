...
class RunUpdateBuffer:
    ...
    def __init__(self) -> None:
        self._delegated_task_updates: dict[str, dict[str, delegation_contracts.StoredDelegatedTask]] = {}
        self._workflow_outcomes: dict[str, dict[str, dict[str, Any]]] = {}

    def record_delegated_task_update(
        self,
        run_id: str | None,
        task: delegation_contracts.StoredDelegatedTask,
    ) -> None:
        ...
        now = time.time()
        bucket[task_id] = delegation_contracts.StoredDelegatedTask(
            task_id=task_id,
    ...
    def consume_delegated_task_updates(
        self,
        run_id: str,
