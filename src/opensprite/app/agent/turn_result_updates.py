...
def with_delegated_tasks(
    ...
    selected_task = delegation_contracts.selected_delegated_task(delegated_tasks)
    return replace(
        result,
...
def merge_delegated_task_updates(
    existing: tuple[delegation_contracts.StoredDelegatedTask, ...],
    updates: tuple[delegation_contracts.StoredDelegatedTask, ...],
    ...
    for update in updates:
        ...
        by_id[update.task_id] = delegation_contracts.StoredDelegatedTask(
    ...
    selected_task = delegation_contracts.selected_delegated_task(
        tuple(task for task in reversed(tasks))
    )
