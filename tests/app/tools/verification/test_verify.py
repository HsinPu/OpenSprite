...
from opensprite.app.tools.verification import verify as verify_module
from opensprite.app.tools.verification.verify import VerifyCommandResult, VerifyTool
