...
from opensprite.modules.search.web_policy import (
    freshness_params as _freshness_params,
    normalize_freshness as _normalize_freshness,
)
from opensprite.modules.search.presentation import (
    format_error as _format_error,
    format_results as _format_results,
)
from opensprite.integrations.search.searxng_http import SEARXNG_MAX_RESPONSE_BYTES, searxng_endpoint_url
...
def test_searxng_search_normalizes_endpoint_url(monkeypatch, base_url, expected_url):
    ...
    monkeypatch.setattr(
        "opensprite.app.tools.web.search.httpx.AsyncClient",
