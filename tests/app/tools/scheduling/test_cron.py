...
from opensprite.config import CronMessagesConfig
...
from opensprite.modules.scheduling.types import CronJob
...
def test_cron_tool_reports_unavailable_while_session_is_resetting():
    messages = CronMessagesConfig(error_manager_unavailable="cron temporarily unavailable")
    tool = CronTool(
        ResettingCronManager(),
    ...
    assert result == "cron temporarily unavailable"
