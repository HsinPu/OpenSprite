...
from opensprite.app.tools.workspace.filesystem import EditFileTool, WriteFileTool
...
def test_write_file_blocks_under_app_skills_dir(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.workspace.paths.get_skills_dir", lambda app_home=None: app_skills)
