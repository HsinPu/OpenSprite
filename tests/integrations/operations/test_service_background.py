...
from opensprite.app.cli.commands import app
from opensprite.integrations.operations import service_background
...
def test_service_install_command_registers_windows_startup_task(monkeypatch, tmp_path):
    monkeypatch.setattr("opensprite.app.cli.commands_service.platform.system", lambda: "Windows")
    monkeypatch.setattr("opensprite.app.cli.commands.service_background.install_startup_task", lambda config_path: "OpenSprite Gateway")
...
def test_service_status_command_renders_detached_status(monkeypatch, tmp_path):
    monkeypatch.setattr("opensprite.app.cli.commands.platform.system", lambda: "Windows")
    monkeypatch.setattr(
        "opensprite.app.cli.commands.service_background.get_service_status",
...
def test_linux_service_status_uses_detached_when_unit_is_not_installed(monkeypatch, tmp_path):
    monkeypatch.setattr("opensprite.app.cli.commands.platform.system", lambda: "Linux")
    monkeypatch.setattr(
        "opensprite.app.cli.commands.service_linux.get_service_file_path",
