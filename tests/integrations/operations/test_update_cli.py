...
from opensprite.integrations.operations import update as update_cli
...
def test_update_check_command_renders_available_count(monkeypatch):
    monkeypatch.setattr(
        "opensprite.app.cli.commands.update_cli.check_update_available",
...
def test_update_command_renders_success(monkeypatch, tmp_path):
    monkeypatch.setattr(
        "opensprite.app.cli.commands.update_cli.update_checkout",
