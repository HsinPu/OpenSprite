...
import opensprite.integrations.web.fetcher as web_fetch_module
from opensprite.integrations.web.fetcher import (
    WebFetcher,
...
def test_web_fetcher_passes_configured_response_size_to_fetch_layer(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher.fetch_url", fake_fetch_url)
...
def test_fetch_url_does_not_retry_cloudflare_challenges(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher._do_fetch", fake_do_fetch)
...
def test_web_fetcher_propagates_403_without_external_fallback(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher.fetch_url", fake_fetch_url)
    monkeypatch.setattr(
        "opensprite.integrations.web.fetcher.extract_with_firecrawl",
...
def test_web_fetcher_uses_configured_firecrawl_when_local_fetch_fails(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher.fetch_url", fake_fetch_url)
    monkeypatch.setattr("opensprite.integrations.web.fetcher.extract_with_firecrawl", fake_firecrawl)
    monkeypatch.setattr("opensprite.integrations.web.fetcher.socket.getaddrinfo", _public_getaddrinfo)
...
def test_web_fetcher_rejects_private_redirect_without_firecrawl(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher.socket.getaddrinfo", _public_getaddrinfo)
    monkeypatch.setattr(
        "opensprite.integrations.web.fetcher.build_opener",
...
def test_web_fetcher_uses_configured_firecrawl_when_local_dns_fails(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher.validate_url", fake_validate_url)
    monkeypatch.setattr(
        "opensprite.integrations.web.fetcher.fetch_url",
...
def test_web_fetcher_keeps_short_locally_extracted_content(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher.html_to_markdown_turndown", lambda html: "Short")
    monkeypatch.setattr(
        "opensprite.integrations.web.fetcher.extract_readability",
...
def test_validate_url_blocks_hosts_that_resolve_private(monkeypatch):
    monkeypatch.setattr(
        "opensprite.integrations.web.fetcher.socket.getaddrinfo",
...
def test_do_fetch_blocks_private_final_url(monkeypatch):
    ...
    monkeypatch.setattr("opensprite.integrations.web.fetcher.socket.getaddrinfo", _public_getaddrinfo)
    monkeypatch.setattr("opensprite.integrations.web.fetcher.build_opener", lambda *args, **kwargs: FakeOpener())
