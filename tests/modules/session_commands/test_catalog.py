"""Tests for the chat-session command catalog."""

from opensprite.modules.session_commands.catalog import session_command_catalog
...
def test_session_command_catalog_is_derived_from_registry():
    ...
    assert {category["name"] for category in catalog["categories"]} >= {"Info", "Session", "Automation", "Maintenance"}
