...
import opensprite.modules.documents.curator as curator_module
from opensprite.modules.documents.curator import CuratorService
from opensprite.integrations.workspace.paths import get_session_curator_state_file
    ...
    async def scenario():
        ...
        def make_service():
            return CuratorService(
                state_store=CuratorStateStore(state_path=state_path),
                maybe_consolidate_memory=noop,
                maybe_update_recent_summary=noop,
                maybe_update_user_profile=noop,
                run_skill_review=noop,
