...
import opensprite.modules.documents.memory_consolidation as consolidation_module
...
from opensprite.modules.documents.memory_consolidation import MemoryConsolidationService
...
def test_memory_consolidation_skips_when_threshold_not_reached(monkeypatch):
    ...
    monkeypatch.setattr(consolidation_module, "_consolidate_memory", fake_consolidate)
