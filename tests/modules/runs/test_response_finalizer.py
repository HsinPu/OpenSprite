...
import opensprite.modules.runs.response_finalizer as response_finalizer_module
from opensprite.modules.runs.response_finalizer import RunResponseFinalizer
...
def _make_finalizer(*, log_reasoning_details=False):
    return RunResponseFinalizer(
        ...
        log_reasoning_details=log_reasoning_details,
    )
