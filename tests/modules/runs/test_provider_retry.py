from opensprite.modules.runs.provider_retry import (
...
def test_retry_delay_uses_jittered_default_for_5xx_without_header(monkeypatch):
    monkeypatch.setattr("opensprite.modules.runs.provider_retry.random.random", lambda: 0.25)
...
def test_retry_delay_increases_jittered_default_by_attempt(monkeypatch):
    monkeypatch.setattr("opensprite.modules.runs.provider_retry.random.random", lambda: 0.5)
