...
def test_contract_is_openapi_31_json() -> None:
    ...
    assert contract["info"]["version"] == "0.7.0-draft"
...
def test_ai_settings_schema_persists_model_response_continuation_and_delivery() -> None:
    ...
    assert set(settings["properties"]) == {"model", "responseMode", "outputContinuation", "responseDelivery", "logFullPrompts", "providerToolPolicies"}
