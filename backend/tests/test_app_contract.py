...
def test_app_routes_and_operation_ids_match_contract() -> None:
    ...
    assert operations == {
        ...
        ("/api/local-paths/pick", "post", "pickLocalPath"),
        ...
        ("/api/schedules/{schedule_id}", "get", "getSchedule"),
        ("/api/schedules/{schedule_id}", "put", "updateSchedule"),
        ("/api/schedules/{schedule_id}", "delete", "deleteSchedule"),
        ("/api/schedules/{schedule_id}/pause", "post", "pauseSchedule"),
        ("/api/schedules/{schedule_id}/resume", "post", "resumeSchedule"),
        ("/api/schedules/{schedule_id}/run-now", "post", "runScheduleNow"),
        (
