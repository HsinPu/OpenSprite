...
MCP_ERROR_STATUS = {
    ...
    McpErrorCode.CREDENTIAL_STORE_UNAVAILABLE: status.HTTP_503_SERVICE_UNAVAILABLE,
...
MCP_PUBLIC_ERRORS = {
    ...
    McpErrorCode.AUTHENTICATION_REQUIRED: ("The MCP server rejected the configured authentication.", False),
    ...
    McpErrorCode.CREDENTIAL_STORE_UNAVAILABLE: ("Secure credential storage is unavailable.", True),
